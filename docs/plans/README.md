...
| [AUR Publication Readiness](./aur-publication-readiness-plan.md) | Readiness tooling implemented; publication blocked | Deterministic release/package tooling and maintainer gates pass; tags, GitHub releases, and AUR submission require later explicit approval. |
