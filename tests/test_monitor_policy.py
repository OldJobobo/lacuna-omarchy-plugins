...
class MonitorPolicyTests(unittest.TestCase):
    ...
    def test_menu_uses_policy_and_refreshes_focus_state(self):
        ...
        self.assertIn("MonitorPolicy.chooseSidebarScreens(Quickshell.screens, sidebarMonitorPolicy, focusedMonitorName, sidebarMonitorNames)", menu)
        self.assertIn("MonitorPolicy.chooseFlyoutScreen(Quickshell.screens, sidebarMonitorPolicy, focusedMonitorName, sidebarMonitorNames)", menu)
