...
class QmlContractTests(unittest.TestCase):
    ...
    def test_lacuna_bar_is_bar_option_frame_host(self):
        ...
        self.assertIn("The bar-owned full-frame strips should start", bar)
        self.assertIn("a visible frameThickness gap at the bar end", bar)
        ...
        self.assertIn("readonly property real edgeShadowSize: Math.max(16, t * 3)", frame)
        ...
        self.assertIn("property real shadowOpacity: 0.62", frame)
        self.assertIn("visible: root.shadowEnabled", frame)
        self.assertIn("y: root.topInset", frame)
        self.assertIn("y: parent.height - root.bottomInset - height", frame)
        self.assertIn("height: root.edgeShadowSize", frame)
        self.assertIn("visible: root.shadowEnabled && !root.leftBar && !root.leftEdgeOccupied", frame)
        self.assertIn("visible: root.shadowEnabled && !root.rightBar && !root.rightEdgeOccupied", frame)
