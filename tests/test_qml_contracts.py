...
class QmlContractTests(unittest.TestCase):
    ...
    def test_background_animations_use_single_selected_effect_contract(self):
        ...
        self.assertIn("cursorShape: Qt.PointingHandCursor", read("lacuna.menu/settings/SettingsRow.qml"))
        self.assertIn("Behavior on scale", read("lacuna.menu/settings/SettingsRow.qml"))
        self.assertIn("visualNormalizedValue", read("lacuna.menu/settings/SettingsRow.qml"))
        self.assertNotIn("Math.round(raw / step) * step", read("lacuna.menu/settings/SettingsRow.qml"))
